(function() {
    ...
    if ('serviceWorker' in navigator && 'PushManager' in window) {
        ...
        //var publicKey = 'BE-TJD3QALDRK3pvA8NrGeozkTCXE3pNAy2C-a4jlZ61HNnRyzlnusRGHtz-SOUB9CJCXkrzIFJFi2FMog4zN84';
        // 注册service worker
    ...
    /* ======= 消息通信 ======= 
    接收ServiceWorker和前端Client的通信，Client.postMessage(action)后触发
    */
    ...
    if ('serviceWorker' in navigator && 'SyncManager' in window) {
        // 一个background sync的基础版,registration.sync 返回SyncManager对象，有register()和getTag()
